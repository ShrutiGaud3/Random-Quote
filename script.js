...
const diceSix='<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path d="M0 96C0 60.7 28.7 32 64 32l320 0c35.3 0 64 28.7 64 64l0 320c0 35.3-28.7 64-64 64L64 480c-35.3 0-64-28.7-64-64L0 96zm160 64a32 32 0 1 0 -64 0 32 32 0 1 0 64 0zM128 288a32 32 0 1 0 0-64 32 32 0 1 0 0 64zm32 64a32 32 0 1 0 -64 0 32 32 0 1 0 64 0zM320 192a32 32 0 1 0 0-64 32 32 0 1 0 0 64zm32 64a32 32 0 1 0 -64 0 32 32 0 1 0 64 0zM320 384a32 32 0 1 0 0-64 32 32 0 1 0 0 64z"/></svg>'
...
{
   quote:' "The beauty of life is in small details, noit in big events." ',
   author:'-Jim Jarmusch'
},
{
    quote:' "Problem disapper when we are willing to become flexible."',
    author:' -Roxana Jones'
},
{
    ...
    quote:'"All it takes is one idea to solve an impossible problem."',
...
function randomDiceButton(){

    // rotate button
    diceBtn.style.transform='rotate(150deg)' 


   const random= Math.floor(Math.random()*randomDice.length)
   diceBtn.innerHTML=randomDice[random]
   


   // Generate a random quote index
    const indexQuotes =Math.floor(Math.random()*randomQuote.length)
    const selectedQuotes=randomQuote[indexQuotes]

  // Set the text for the heading and paragraph
    heading.innerText=selectedQuotes.quote
    para.innerText=selectedQuotes.author
...
diceBtn.addEventListener('click',randomDiceButton)
